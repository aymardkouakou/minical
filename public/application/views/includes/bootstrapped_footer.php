...
<div class="modal fade" id="display-cc-details" data-backdrop="static" data-keyboard="false" style="z-index: 9999;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script>
    ...
    <
    !--Below script used
    for store current session value-- >
...
<script type="text/javascript">
    ...
    mixpanel.init("3bc910ef237696a92d7ca663bafa883c");
</script><!-- end Mixpanel -->
