...
<form action="<?php echo base_url(); ?>auth/forgot_password" class="
		col-md-push-4
		col-md-4
		col-md-pull-4
		text-center
		" method="post" accept-charset="utf-8" style="
		margin-top:100px;
		margin-bottom:100px;
	">
	...
	<div class="form-group">
		...
		<input class="btn btn-primary btn-block" type="submit" name="submit" value="Obtenir un nouveau mot de passe">
	</div>
