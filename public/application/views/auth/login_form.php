...
<div class="col-md-6">
    ...
    margin: auto;">
		...
		<div class="form-group">
			...
			<input type="password" id="password" name="password" class="form-control" placeholder="Mot de passe" required value="<?php echo $password; ?>">
		</div>
		<!--
		<div class="checkbox">
		...
		<div class="form-group">
			<input class="btn btn-lg btn-primary btn-block" id="log-in-button" type="submit" name="submit" value="Connexion">
		</div>
		...
		<div style="font-size: 13px;">
			...
			<?php if (isset($whitelabel_detail['terms_of_service']) && $whitelabel_detail['terms_of_service']) { ?>
				<a href="<?php //echo $whitelabel_detail['terms_of_service']; 
							?>" target="_blank">Terms of Use</a>
			<?php } else { ?>
				<a href="<?php //echo base_url(); 
							?>auth/show_terms_of_service" target="_blank">Terms Of Use</a>
			<?php } ?>
			<?php //echo " and " 
			?>

			<?php if (isset($whitelabel_detail['privacy_policy']) && $whitelabel_detail['privacy_policy']) { ?>
				<a href="<?php //echo $whitelabel_detail['privacy_policy']; 
							?>" target="_blank">Privacy Policy</a>
			<?php } else { ?>
				<a href="<?php //echo base_url(); 
							?>auth/show_privacy_policy" target="_blank">Privacy Policy</a>
			<?php } ?>
